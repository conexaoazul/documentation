...
Databases hosted on Odoo Online and using an odoo.com domain name benefit from a free and
ready-to-use Plausible.io solution. It automatically generates credentials, creates and sets up
a Plausible account. Go to :menuselection:`Website --> Configuration --> Settings`, then in the
:guilabel:`Tracking & SEO` section, activate the :guilabel:`Plausible Analytics` option. The
...
.. note::
   **If you already have a Plausible.io account** and you want to connect it to your Odoo Online
   ...
   Then, follow the steps to :ref:`set up your account <analytics/account-setting>` to connect your
   existing account with Plausible.io servers.
...
account and subscription or, if you wish, sign in to an existing one. Then follow the steps to
:ref:`set up your account <analytics/account-setting>`.
...
#. Create or sign in to a Plausible.io account.
