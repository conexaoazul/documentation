...
After installing the *Phone - OnSIP* module, go to the :menuselection:`Phone app --> Configuration
--> Providers`. Locate the *OnSIP* provider entry, and enter the following information:
...
If an *Incorrect Number* message appears in the *Odoo Phone* widget, make sure to include the phone
number's international country code. For example: in the phone number `16505555555`, `1` is the
international country code for the United States.
...
with Odoo *Phone*. The OnSIP softphone app is available on Windows, macOS, Linux, iOS, and Android.
