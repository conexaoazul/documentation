...
This opens a :guilabel:`Convert to opportunity` pop-up. Here, select the :guilabel:`Convert to
opportunity` option in the :guilabel:`Conversion Action` field.
...
---------------------------------------
   ...
   If a :guilabel:`Similar Leads` smart button appears at the top of the page for the lead, a
   similar lead or opportunity already exists in the database. Before converting the current lead,
   click the smart button to check if the leads should be merged.
   ...
   :guilabel:`Conversion Action` field. This generates a list of the similar leads/opportunities to
   be merged.
